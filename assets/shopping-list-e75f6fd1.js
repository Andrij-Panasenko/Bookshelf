import{s as p,S as r,t as b}from"./modal-pop-up-08249b26.js";const d=document.querySelector(".shopping-book-list");document.querySelector(".shopping-book");document.querySelector(".header-menu-shop");const g=document.querySelector(".stub");d.addEventListener("click",f);function h(s){const a=s.map(({book_image:n,title:o,list_name:t,author:u,description:l,buy_links:c,_id:e})=>{const m=c.find(i=>i.name==="Amazon"),k=c.find(i=>i.name==="Apple Books");return`<li class="shopping-book" data-id="${e}">
